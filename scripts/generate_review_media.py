...
SECTIONS = [
    (0, 10, "Two hundred forty-five option contracts enter. Twenty-one survive. Eight pass expiration. Four pass liquidity. Two form a defined-risk spread. The capital gate closes."),
    (10, 35, "Most trading agents search for a reason to trade. But when AI can move capital, prediction is only half the problem. The harder question is authority. Which safety policy deserves the right to execute? Seoul Shield answers with one signal, one snapshot, and four policies."),
